            ...
            <div className="info flex flex-col gap-6 xl:w-[600px] lg:w-[600px]">
              ...
              <div className="details flex flex-col gap-4">
                <p className="role text-2xl font-medium dark:text-light-text-primary">
                  Desenvolvedor Javascript e Entusiasta em Design
                </p>
                <p className="auto-description text-text-secondary text-base dark:text-light-text-secondary">
                  Mais de 2 anos de experiência em desenvolvimento com
                  Javascript. Entusiasta na construção de aplicações web
                  utilizando tecnologias como Javascript/Typescript, Angular e
                  Node.js.
                </p>
              </div>
            ...
            <div className="flex flex-col px-6 py-12 lg:xl:max-w-xl xl:max-w-xl">
              ...
              <div>
                ...
                <h2 className="role text-2xl dark:text-light-text-primary font-medium mb-4">
                  Sou um desenvolvedor apaixonado por software, em busca da
                  primeira oportunidade na área de Tecnologia da Informação
                </h2>
                <p className="text-text-secondary dark:text-light-text-secondary mb-12">
                  Além de codar, sou um entusiasta do chá de Maçã, um amante de
                  cachorros e um filósofo autodidata que gosta passar o tempo
                  livre estudando o Estoicismo. No momento estou buscando
                  oportunidades para levar minhas habilidades para empresas de
                  tecnologia no Brasil, com a perspectiva de ser admitido em
                  vagas internacionais em breve.
                </p>
              </div>
              <a
        ...
        >
          <div className="">
            ...
            <div className="flex flex-col gap-4 lg:max-w-xl xl:max-w-xl">
              ...
              <h2 className="text-2xl font-bold dark:text-light-text-primary">
                Gostou do meu trabalho? Trabalhe comigo
              </h2>
              <p className="dark:text-light-text-secondary">
                Estou sempre pronto para uma conversa. Envie um email para:{" "}
                <a
                ...
                ou chame minha atenção nas redes sociais.
              </p>
          ...
          <div className="w-full">
            <form className="flex flex-col gap-4 mt-12" onSubmit={handleSubmit}>
              ...
              <Button label="Me envie uma mensagem" icon={FaArrowRightLong} />
            </form>
          </div>
        </div>
      </main>
